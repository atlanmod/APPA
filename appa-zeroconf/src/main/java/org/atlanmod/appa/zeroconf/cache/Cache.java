...
import org.atlanmod.appa.zeroconf.mdns.PointerRecord;
import org.atlanmod.appa.zeroconf.mdns.ServerSelectionRecord;
import org.atlanmod.appa.zeroconf.names.ApplicationProtocol;
import org.atlanmod.appa.zeroconf.names.HostName;
import org.atlanmod.appa.zeroconf.names.ServiceName;
...
Again, the 28800 is the time-to-live (TTL) value, measured in seconds.
    ...
    public void updateFrom(ServerSelectionRecord srv) throws ParseException {
        //_printer._tcp.local. 28800 PTR PrintsAlot._printer._tcp.local.
    ...
    public void updateFrom(PointerRecord ptr) {
        ptr.name();
        ptr.qclass();
     ...
     */
    public void updateFrom(ARecord ip4address) throws ParseException {
