...
public class RemoteTesterImpl implements Tester, Serializable {
    ...
    /**
     * Returns the next TestStep to execute. Blocks until a new TestStep is
     * available.
     *
    ...
    /**
     * Returns the coordinator for this tester. Blocks until the coordinator is
     * available.
     *
    ...
    /**
     * Waits for the arrival of a start message. Blocks the current thread until
     * the start attribute becomes true;
     *
     * @throws InterruptedException
     */
    ...
    /**
     * Returns true if the current tester should quit and false for any other
     * case.
     *
